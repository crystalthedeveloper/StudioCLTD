...
export const hubSections: HubSection[] = [
  ...
  { id: "offers", name: "Offers", icon: "O", position: [-56, 2.1, -36], entrance: [1, 0], color: "#E8ECEF", accent: "#ff9f1c" },
  ...
  { id: "showcase", name: "Showcase", icon: "SC", position: [10, 4.2, -84], entrance: [0, 1], color: "#E8ECEF", accent: "#E8ECEF" },
];
